window.I18N = {
  ko: {
    ...
    dividendDesc: "직전 사업연도말 기준 미분배이익잉여금(BS 未分配利润)입니다. 이 계정이 당기순이익(本年利润)을 이미 포함하므로 따로 더하지 않습니다. 세무·외환 절차 전 이론치이며 실제 송금가능액과 다릅니다.",
    dividendBase: "기준시점",
    dividendSource: "읽은 BS",
    dividendMethodDirect: "기준월 BS 직접 조회",
    dividendMethodBackcast: "{ym} BS에서 역산",
    dividendMethodNodata: "BS 자료 없음",
    dividendBackcastNote: "기준월({base}) BS가 아직 입력되지 않아 {src} 자료로 역산했습니다. 역산식: {src} BS 미분배이익잉여금 − PL 당기순이익 누계.",
    dividendRetained: "미분배이익잉여금",
    dividendNetIncome: "당기순이익 (참고, 위에 포함됨)",
  ...
  zh: {
    ...
    dividendDesc: "按上一会计年度末计算的未分配利润（BS 未分配利润）。该科目已包含本年利润，故不另行加计。这是办理税务·外汇手续前的理论值，与实际可汇出金额不同。",
    dividendBase: "基准时点",
    dividendSource: "所取BS",
    dividendMethodDirect: "直接读取基准月BS",
    dividendMethodBackcast: "由{ym}的BS倒推",
    dividendMethodNodata: "无BS资料",
    dividendBackcastNote: "基准月({base})的BS尚未录入，因此依据{src}的资料倒推。倒推公式：{src} BS 未分配利润 − PL净利润累计。",
    dividendRetained: "未分配利润",
    dividendNetIncome: "本年利润（参考，已含于上项）",
